...
export const initialAdhesiveYields = [
    ...
    { line: 'Línea Translúcida', standard: '0.5 unidades (Adhesivo Translúcido)', xl: '2 unidades (Adhesivo Translúcido)' },
    { line: 'Línea Metales', standard: '1.5 unidades (2.44x0.61)', xl: '3 unidades (2.44x1.22)' },
