...
export const initialAdhesiveYields = [
    ...
    { groupName: 'Metálicos y Maderas', productNames: ['Corten stell', 'Mural blue patina with copper', 'Mural white with copper gold', 'Gate turquoise patina copper', 'Corten steel', 'Madera nogal', 'Madera teka', 'Madera ébano'], yield: 1.5, isTranslucent: false },
];
