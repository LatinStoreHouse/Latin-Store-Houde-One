...
export const initialCustomerData: Customer[] = [
  ...
  { id: 2, name: 'Bob Williams', phone: '555-0102', email: 'bob@example.com', address: 'Cr 45 # 67 - 89', city: 'Bogotá', source: 'WhatsApp', assignedTo: 'Jane Smith', status: 'Cotizado', registrationDate: '2024-07-20' },
  ...
  { id: 4, name: 'Diana Miller', phone: '555-0104', email: 'diana@example.com', address: '', city: 'Cali', source: 'Instagram', assignedTo: 'Peter Jones', status: 'Declinado', registrationDate: '2024-06-25' },
