...
export const initialCustomerData: Customer[] = [
  { id: 1, name: 'Alice Johnson', phone: '555-0101', email: 'alice@example.com', taxId: '12345678-9', address: 'Av Falsa 123', city: 'Cali', source: 'Instagram', assignedTo: 'John Doe', status: 'Contactado', registrationDate: '2024-07-15' },
  { id: 2, name: 'Bob Williams', phone: '555-0102', email: 'bob@example.com', taxId: '87654321-0', address: 'Cr 45 # 67 - 89', city: 'Bogotá', source: 'WhatsApp', assignedTo: 'Jane Smith', status: 'Cotizado', registrationDate: '2024-07-20', notes: 'Cliente muy interesado en la línea Starwood, solicitó catálogo completo.' },
  { id: 3, name: 'Charlie Brown', phone: '555-0103', email: 'charlie@example.com', taxId: '11223344-5', address: '', city: 'Medellín', source: 'Email', assignedTo: 'John Doe', status: 'Facturado', registrationDate: '2024-06-10' },
  { id: 4, name: 'Diana Miller', phone: '555-0104', email: 'diana@example.com', taxId: '55667788-9', address: '', city: 'Cali', source: 'Instagram', assignedTo: 'Peter Jones', status: 'Declinado', registrationDate: '2024-06-25', notes: 'El cliente encontró una opción más económica con la competencia.' },
  ...
  { id: 8, name: 'International Corp', phone: '555-0108', email: 'contact@inter.co', taxId: '99887766-1', address: '123 Global Way', city: 'Miami', source: 'Referido', assignedTo: 'Jane Smith', status: 'Contactado', registrationDate: '2024-07-22' },
];
