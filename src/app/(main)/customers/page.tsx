...
export interface Customer {
  ...
  assignedTo: string;
  status: 'Nuevo Lead' | 'Contactado' | 'Convertido' | 'Inactivo';
}

const initialCustomerData: Customer[] = [
  { id: 1, name: 'Alice Johnson', phone: '555-0101', email: 'alice@example.com', source: 'Instagram', assignedTo: 'John Doe', status: 'Nuevo Lead' },
  { id: 2, name: 'Bob Williams', phone: '555-0102', email: 'bob@example.com', source: 'WhatsApp', assignedTo: 'Jane Smith', status: 'Contactado' },
  { id: 3, name: 'Charlie Brown', phone: '555-0103', email: 'charlie@example.com', source: 'Email', assignedTo: 'John Doe', status: 'Convertido' },
  { id: 4, name: 'Diana Miller', phone: '555-0104', email: 'diana@example.com', source: 'Instagram', assignedTo: 'Peter Jones', status: 'Inactivo' },
  { id: 5, name: 'Ethan Davis', phone: '555-0105', email: 'ethan@example.com', source: 'Email', assignedTo: 'Jane Smith', status: 'Nuevo Lead' },
];
