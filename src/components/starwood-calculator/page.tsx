...
import StarwoodLogo from '@/assets/images/logos/Logo-Starwood-color.png';
...
export default function StarwoodCalculatorPage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    const starwoodLogoData = await getImageBase64(StarwoodLogo);
      ...
      <CardHeader>
        <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
                ...
                <Image src={StarwoodLogo} alt="Starwood Logo" width={80} height={26} className="object-contain"/>
            </div>
        </div>
      </CardHeader>
